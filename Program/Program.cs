...
Console.WriteLine("~~~ ViewModel 1: Normie ~~~");
...
//Imposible becuase internal ~~~~~~~~~~~~~~~~~~~~~
//viewModel2.SetText("Hi");
MethodInfo method = viewModel2.GetType().GetMethod("SetText", BindingFlags.NonPublic | BindingFlags.Instance)!;
method?.Invoke(viewModel2, ["Hi"]);
